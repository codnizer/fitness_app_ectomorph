...
const PrivacyModal = () => {
  return (
    ...
    <div className="modal-box bg-slate-800 text-white poppins-regular text-[25px] h-[75%] overflow-hidden ">
    <form method="dialog">
        <button  className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
      </form>
      <h3 className="font-bold text-2xl text-center border-b-2 pb-2  ">Privacy Policy</h3>
      <div className='flex flex-col gap-4 mt-4 text-[20px] poppins-light h-[90%] overflow-scroll ' > 
         
      <strong>Privacy Policy</strong>
<p>This privacy policy applies to the Soccer Mind app (hereby referred to as "Application") for mobile devices that was created by Codnizer (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
...
<p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to codnizer@gmail.com. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
...
<p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at codnizer@gmail.com and they will respond in a reasonable time.</p>
...
<p>This privacy policy is effective as of 2024-04-04</p>
...
<p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at codnizer@gmail.com.</p>
</div>
